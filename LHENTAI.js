...
function getRandomUserAgent() {
 ...
 if (process.argv.length < 7){console.log(`PARMAR\n Usage: node LHENTAI.js target time rate thread proxyFile`); process.exit();}
...
console.log(`
             ...
             ╚╦════════════════════════════════════════╦╝
           ╔══╩════════════════════════════════════════╩═══╗
             Method DDoS By t.me/LeakedDdos | t.me/ParmarMods
           ╚══╦═════════════════════════════════════════╦══╝
              ╚═════════════════════════════════════════╝
`)
console.log(`[PARMAR] Target: `+ process.argv[2])
console.log(`[PARMAR] Time: `+ process.argv[3])
console.log(`[PARMAR] Rate: `+ process.argv[4])
console.log(`[PARMAR] Thread: ` + process.argv[5])
console.log(`[PARMAR] Request: GET`)
console.log(`[PARMAR] Methods: LHentai`)
console.log(`[PARMAR] Methods DDoS By MAFIA`)
